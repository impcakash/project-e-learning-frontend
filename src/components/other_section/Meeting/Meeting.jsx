    ...
    <>
      <div className="bdy_u">
        <header className=" bdy_u2">
          ...
          <img
            className="image2_u"
            src="https://tse1.mm.bing.net/th?id=OIP.ZiTW0_Bt-77kKvRweb7hLAHaHa&pid=Api&P=0&h=180"
            alt=""
          />
        </header>
...
{/* ..course contents.. */}
                ...
                <button className="p-2 ronded-full bg-teal-50 hover:bg-teal-100">
                  <span className="material-icons w- text-teal-600">
                    {" "}
                    <button>
                  ...
                  {activeTab === 2 && (
                    <div className="mt-2 ml-4 text-gray-700">
                      ...
                      <p>
                        ...
                        <span className="float-right">25:00</span>
                      </p>
                      <p>
                        3. Lorem ipsum dolor sit amet{" "}
                        <span className="float-right">30:00</span>
                      </p>
                    </div>
                  )}
                </div>
