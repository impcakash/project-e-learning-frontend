    ...
    <div className="py-6 px-2 max-w-auto bg-white">
      ...
      <div className="bg-teal-500 p-6 py-2 text-white">
        ...
        <div className="flex justify-end items-center">
          <span className="text-md">
            <i class="fa-regular fa-clock mr-3"></i>1 hour
          </span>
        </div>
      </div>
      ...
      <div className="bg-blue-50 p-6">
        ...
        <p className="text-gray-600 text-xs mt-5 mb-8">
          ...
          earum voluptatibus aliquam non ad quasi molestias fugiat voluptatum
          beatae praesentium quibusdam tempore, adipisci vel commodi. Nostrum
          iure laboriosam officiis provident sunt? Temporibus enim, fugiat
          ipsum, eos itaque non nobis libero sequi inventore quis quae nesciunt
          expedita delectus iste, saepe nihil adipisci sapiente atque
          dignissimos amet!
        </p>
          ...
          <div className="w-full md:w-1/2 p-4 border-black md:border-r">
            ...
            <div className="grid grid-cols-7 text-center gap-y-4">
              {["S", "M", "T", "W", "T", "F", "S"].map((day, idx) => (
                <div key={idx} className="text-gray-500 font-semibold">
                  {day}
                </div>
              ))}
          ...
          <div className="w-full md:w-1/2 p-4">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between p-2 bg-red-50 rounded-lg shadow-md">
                <span>2 PM</span>
                <span className="bg-red-200 text-red-500 px-3 py-1 rounded-full">
                  Adobe XD Live Class
                </span>
              </div>
