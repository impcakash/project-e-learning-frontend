    ...
    <footer className=" bg-[#1E1E3F] text-white h-[400px] flex items-center justify-center">
      <div className="max-w-2xl w-full px-4 flex flex-col items-center text-center space-y-16">
        ...
        <div className="mt-6">
          ...
          <div className="flex items-center justify-center space-x-2">
            ...
            <input
              type="email"
              placeholder="Your Email"
              className="px-4 py-2 rounded-full w-full sm:w-60 md:w-80 bg-gray-800 text-gray-300 placeholder-gray-400 focus:outline-none border-2 border-gray-500"
            />
            <button className="bg-teal-500 hover:bg-teal-600 text-white px-5 sm:px-7 py-2 rounded-full w-full sm:w-auto">
              Subscribe
            </button>
          </div>
        </div>
        ...
        <div className="text-gray-400 text-sm mt-6">
          ...
          <p className="text-xs">&copy; 2024 Class Technologies Inc.</p>
        </div>
      </div>
    </footer>
  );
