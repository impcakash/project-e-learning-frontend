    ...
    <nav className="bg-teal-400">
        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex space-x-6">
            ...
            <div className="relative">
              ...
              {isOpen && (
                <div className="absolute right-0 mt-2 w-32 bg-white rounded-md shadow-lg py-2">
                  <a href="#option1" className="block px-4 py-2 text-gray-700 hover:bg-teal-100">Option 1</a>
                  <a href="#option2" className="block px-4 py-2 text-gray-700 hover:bg-teal-100">Option 2</a>
                  <a href="#option3" className="block px-4 py-2 text-gray-700 hover:bg-teal-100">Option 3</a>
                </div>
              )}
            </div>
          </div>
      ...
      {isOpen && (
        <div className="md:hidden bg-teal-400">
          ...
          <a href="#others" className="block px-4 py-2 text-white">Others</a>
